...
// Sample list of colleges for demonstration
const collegesList = [
...
const SignupLogin = ({ isOpen, onLoginSuccess,onClose }) => {
  ...
  // Handle click outside of college dropdown
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (collegeSearchRef.current && !collegeSearchRef.current.contains(event.target)) {
      ...
      <div className="signup-login-container">
        <div className="auth-form profile-view">
          ...
          <div className="user-avatar">
            {/* Display Gravatar image or default avatar using user's email */}
            <img 
              src={`https://www.gravatar.com/avatar/${MD5(user.email.toLowerCase().trim())}?d=identicon`} 
              alt="User profile" 
            />
          </div>
  ...
  return (
    <div className="signup-login-container" onClick={console.log('clicked')}>
      <div className="auth-form">
        ...
        <form onSubmit={mode === 'login' ? handleLogin : handleSignup}>
          ...
          {mode === 'signup' && (
            <div className="form-group college-search" ref={collegeSearchRef}>
              <label>College</label>
              <input
                type="text"
                placeholder="Search for your college"
                value={collegeName || searchTerm}
                onChange={(e) => {
                ...
                required
              />
              {showCollegeOptions && searchResults.length > 0 && (
                <ul className="college-options">
                  {searchResults.map((college, index) => (
                    <li key={index} onClick={() => selectCollege(college)}>
                      {college}
                    </li>
                  ))}
                </ul>
